        ...
        try {
            ...
            if (object && object.message && object.message.length > 0) {
                ...
                if (object) {
                    ...
                    translateProperty(object, 'humidity_control_settings', null, (humidityControlSetting, id) => {
                        if (checkDeviceExists(body, id)) {
                            body.device[id].target_humidity = humidityControlSetting.data.property.value.targetHumidity.value;
                        }
                    });
    ...
    legacyToProtobufUpdate(body) {
        function addToOutput(output, currentState, device, protoKey, protoType, key, value) {
            ...
            if (!found) {
                ...
                if (protoType == 'type.nestlabs.com/nest.trait.hvac.TargetTemperatureSettingsTrait') {
                    ...
                    newEl.property.value = { };
                } else if (protoType == 'type.nestlabs.com/nest.trait.hvac.HumidityControlSettingsTrait') {
                    newEl.property.value = {
                        targetHumidity: { value: currentState.device[device].target_humidity }
                    };
                }
            ...
            if (key == 'target_temperature_type') {
                ...
                found.property.value.targetHumidity = { value: value };
            }
        }
        ...
        data.forEach(req => {
            ...
            for (const key in prop) {
                ...
                } else if (['target_humidity'].includes(key)) {
                    protoKey = 'humidity_control_settings';
                    protoType = 'type.nestlabs.com/nest.trait.hvac.HumidityControlSettingsTrait';
                } else {
                    known = false;
                }
                if (known) {
